...
"[project]/src/app/(admin)/admin/appointments/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminAppointmentsPage() {
    ...
    const [filterDoctor, setFilterDoctor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [filterService, setFilterService] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    async function loadAppointments() {
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/admin/appointments");
    ...
    async function handleSave(e) {
        ...
        try {
            if (editing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/api/admin/appointments/${editing.AppointmentId}`, body);
                pushToast({
                    type: "success",
                    title: "Appointment updated"
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/api/admin/appointments", body);
                pushToast({
                    type: "success",
    ...
    async function handleDelete(a) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].del(`/api/admin/appointments/${a.AppointmentId}`);
            pushToast({
                type: "success",
    ...
    async function handleCancel(a) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/api/admin/appointments/${a.AppointmentId}`, {
                ...a,
                Status: "Cancelled"
            });
            pushToast({
...
_s(AdminAppointmentsPage, "o9AYYG+gnPg6xD5+Mew4icnvezE=", false, function() {
    return [
...
//# sourceMappingURL=src_7f662ef7._.js.map