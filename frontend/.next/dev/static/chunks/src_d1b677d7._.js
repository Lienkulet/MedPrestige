...
"[project]/src/components/admin/ToastProvider.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: toasts.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            t.message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(ToastProvider, "sYXTYLpBVp9NvoXCceEeu8oaLhI=");
_c = ToastProvider;
var _c;
...
function AdminDoctorsPage() {
    ...
    async function loadDoctors() {
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/admin/doctors");
            setDoctors(data);
        } catch  {
            pushToast({
                type: "error",
    ...
    async function loadServices() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/admin/services");
            setServices(data);
        } catch  {}
    }
        ...
        "AdminDoctorsPage.useMemo[rows]": ()=>{
            return doctors.filter({
                "AdminDoctorsPage.useMemo[rows]": (d)=>{
                    ...
                    const email = d.Email ?? "";
                    const okQuery = name.toLowerCase().includes(query.toLowerCase()) || occupation.toLowerCase().includes(query.toLowerCase()) || email.toLowerCase().includes(query.toLowerCase());
    ...
    async function handleSave(e) {
        ...
        try {
            if (editing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/api/admin/doctors/${editing.DoctorId}`, body);
                pushToast({
                    type: "success",
                    title: "Doctor updated"
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/api/admin/doctors", body);
                pushToast({
                    type: "success",
    ...
    async function handleDelete(d) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].del(`/api/admin/doctors/${d.DoctorId}`);
            pushToast({
                type: "success",
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "checkbox",
                                                    checked: checked,
                                                    onChange: ()=>setSelectedServiceIds((prev)=>checked ? prev.filter((id)=>id !== s.ServiceId) : [
                                                                ...prev,
                                                                s.ServiceId
                                                            ])
                                                }, void 0, false, {
...
_s(AdminDoctorsPage, "0PKyInZOphYOJxb+ELfFRgUP4hA=", false, function() {
    return [
...
//# sourceMappingURL=src_d1b677d7._.js.map