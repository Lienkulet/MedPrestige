...
const ArrowIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 10h12M12 6l4 4-4 4" stroke="#2F73F2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)
...
const Services = () => {
  return (
    <main>
      <PagesHero
        title="Our Services"
        subtitle="We offer a wide range of specialized medical services to meet all your healthcare needs."
      />
      ...
      <div className="services-list">
        {services.map((service, index) => (
          <div
            ...
            key={service.id}
          >
            <div className="service-row-icon-placeholder">
              {service.icon}
            </div>
